...
<div class="container-sm">
    ...
    <div class="card border-light">
        <h4 class="text-center">Busca un Viaje!</h4>
        <?php
        echo view('mapa/mapa');
        ?>
        <br>
        <div class="form ">
            <div class="row text-center aling-item-center justify-content-center">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-auto">
        ...
        <div class="row text-center aling-item-center justify-content-center">
            <div class="col-sm-12">
                <a href="<?php echo base_url('/cliente/searching'); ?>" type="button" class="btn btn-dark rounded-pill">Solicitar Viaje</a>
            </div>
        </div>
        <br>
    </div>
